...
export BASEINSTALL=/cvmfs/sft.cern.ch/lcg/views/LCG_104/x86_64-el9-gcc13-opt/
...
export HepMC_DIR=/cvmfs/sft.cern.ch/lcg/releases/HepMC/2.06.11-d5a39/x86_64-el9-gcc13-opt/
